...
public class LevelGeneration : MonoBehaviour
{
    ...
    {
        //setup
        rooms = new RoomProcedural[gridSizeX * 2, gridSizeY * 2];
        rooms[gridSizeX, gridSizeY] = new RoomProcedural(Vector2.zero, 1);
        ...
        for (int i = 0; i < numberOfRooms - 1; i++)
        {
            ...
            //finalize position
            rooms[(int)checkPos.x + gridSizeX, (int)checkPos.y + gridSizeY] = new RoomProcedural(checkPos, 0);
    ...
    void DrawMap()
    {
        foreach (RoomProcedural room in rooms)
        {
            if (room == null)
            {
